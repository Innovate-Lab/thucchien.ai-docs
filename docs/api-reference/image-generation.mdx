...
<ApiReferenceLayout>
  ...
  Ngoài endpoint này, bạn cũng có thể tạo ảnh bằng cách sử dụng các mô hình đa phương thức thông qua endpoint [`/chat/completions`](/docs/user-guide/image-generation#2-phương-pháp-trò-chuyện-endpoint-chatcompletions).
  :::
