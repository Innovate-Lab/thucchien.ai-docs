---
sidebar_position: 10
title: Kiểm tra chi tiêu
description: Kiểm tra thông tin API key và chi tiêu hiện tại.
      ...
      <div className={styles.infoSection}>
        ...
        <div className={styles.infoRow}>
          ...
          <span className={styles.infoValue}>
            {info.blocked ? (
              <span className={styles.statusBadgeDanger}>● Blocked</span>
            ) : (
              <span className={styles.statusBadgeSuccess}>● Active</span>
            )}
          </span>
        </div>
        <div className={styles.infoRow}>
...
<ApiReferenceLayout>
  <LeftColumn>
    ...
    <ApiParameter name="tpm_limit" type="number" indent={2}>
      Giới hạn tokens per minute. `null` nếu không giới hạn.
    </ApiParameter>
    <ApiParameter name="rpm_limit" type="number" indent={2}>
      Giới hạn requests per minute. `null` nếu không giới hạn.
    </ApiParameter>
...
fetch(url, {
  ...
  .catch(error => console.error('Error:', error));`,
      ...
      buildBody={null}
      exampleResponse={{
        "key": "913b4e1f166a6be4dae7544498c2bef96046ed5f5f7b3dfa345a11d8f63a4923",
        "info": {
          "key_name": "sk-...vgJA",
          "key_alias": "team1@key",
          ...
          "aliases": {},
          "config": {},
          "user_id": "85068790-77f3-4b51-9304-7114f2fba733",
          "team_id": "b75a2976-fe49-418c-bf77-70f86c1ee656",
          "permissions": {},
          ...
          "created_at": "2025-10-14T02:48:21.288000+00:00",
          "created_by": "default_user_id",
          "updated_at": "2025-10-14T02:50:14.513000+00:00",
