...
<ApiReferenceLayout>
  <LeftColumn>
    ...
    <ApiParameter name="image" type="object" indent={1} isEnd>
      Một hình ảnh ban đầu để tạo hiệu ứng hoạt hình (chưa hỗ trợ trong ví dụ tương tác).
    </ApiParameter>
    ...
    <ApiParameter name="personGeneration" type="string" indent={1} isEnd>
      ...
      - **Veo 3 (Text-to-video)**: Chỉ hỗ trợ `"allow_all"`.
      - **Veo 2 (Text-to-video)**: Hỗ trợ `"allow_all"`, `"allow_adult"`, `"dont_allow"`.
    </ApiParameter>
