...
<Tabs>
  <TabItem value="curl" label="curl">
    ...
    {`# Cấu hình
API_URL="https://api0.lab.AI-server.com/v1/images/generations"
...
# --- Cấu hình ---
AI_API_BASE = "https://api0.lab.AI-server.com/v1"
...
# --- Cấu hình ---
AI_API_BASE = "https://api0.lab.AI-server.com"
AI_API_KEY = "<your_api_key>"
...
IMAGE_DATA=$(curl -s https://api0.lab.AI-server.com/v1/chat/completions \\
