...
import GeneratedImage1 from '@site/static/img/generated_image_1.png';
import GeneratedImage2 from '@site/static/img/generated_image_2.png';
import GeneratedChatImage from '@site/static/img/generated_chat_image.png';
...
if [ "$image_count" -gt 0 ]; then
  ...
  echo "$response"
    ...
    <div style={{"display": "flex", "gap": "10px"}}>
      <img src={GeneratedImage1} alt="Generated Image 1" style={{"width": "49%"}}/>
      <img src={GeneratedImage2} alt="Generated Image 2" style={{"width": "49%"}}/>
    </div>
  </TabItem>
...
# --- Cấu hình ---
AI_API_BASE = "https://api0.lab.vbi-server.com/v1"
...
if [ -n "$IMAGE_DATA" ]; then
  ...
  echo "Failed to get image data."
    ...
    <div style={{"display": "flex", "justifyContent": "center"}}>
      <img src={GeneratedChatImage} alt="Ví dụ hình ảnh được tạo ra" style={{"maxWidth": "512px", "width": "100%"}}/>
    </div>
  </TabItem>
  <TabItem value="python-requests" label="Python (requests)">
...
try:
    ...
    base64_string = response.choices[0].message.image.get('url')
    print("Image data received successfully.")
...
# Configure Litellm to use VBI API
...
base64_string = response.choices[0].message.provider_specific_fields.get('image').get('url')
print("Image data received successfully.")
...
:::tip[Ghi chú]
Để biết thêm chi tiết, bạn có thể tham khảo tài liệu về sinh ảnh từ [Google Cloud Vertex AI](https://cloud.google.com/vertex-ai/docs/generative-ai/image/generate-images) và các tham số sinh ảnh cho Google AI Studio qua [LiteLLM](https://docs.litellm.ai/docs/providers/google_ai_studio/image_gen#supported-parameters).
:::
