...
<Tabs>
  ...
  "name": "models/veo-3.0-generate-preview/operations/idrk08ltkg0a"
    ...
    <CodeBlock language="bash">
    {`# URL kiểm tra trạng thái: https://api0.lab.vbi-server.com/gemini/v1beta/models/veo-3.0-generate-preview/operations/idrk08ltkg0a
curl https://api0.lab.vbi-server.com/gemini/v1beta/models/veo-3.0-generate-preview/operations/<operation_id> \\
  -H "x-goog-api-key: <your_api_key>"`}
    </CodeBlock>
...
# URL tải xuống qua proxy: https://api0.lab.vbi-server.com/gemini/download/v1beta/files/3j6svp4106e7:download?alt=media

curl https://api0.lab.vbi-server.com/gemini/download/v1beta/files/<video_id>:download?alt=media \\
  -H "x-goog-api-key: <your_api_key>" \\
