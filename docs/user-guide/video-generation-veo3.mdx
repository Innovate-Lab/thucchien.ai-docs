...
Ngoài `prompt`, bạn có thể chỉ định thêm [các tham số khác](https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/veo-video-generation) trong body của yêu cầu ở **Bước 1** để kiểm soát video được tạo ra, ví dụ như thời lượng, chất lượng, v.v.
