---
title: "Quy định & Hướng dẫn kỹ thuật — Vòng Chung khảo (Thi trực tuyến)"
sidebar_label: Quy định & Hướng dẫn kỹ thuật
---
...
- 01 máy tính (PC hoặc laptop) có kết nối Internet để thực hiện các yêu cầu của đề thi. Máy tính này sẽ được kết nối với hệ thống giám sát của Ban tổ chức — hệ thống sẽ ghi lại toàn bộ hoạt động trên màn hình trong suốt quá trình thi.
...
![Mẫu góc quay 1](/img/technical_setup/sample_1.png)
...
![Mẫu góc quay 2](/img/technical_setup/sample_2.png)
:::tip[Lưu ý]
