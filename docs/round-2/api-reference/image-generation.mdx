...
<ApiReferenceLayout>
  ...
  Ngoài endpoint này, bạn cũng có thể tạo ảnh bằng cách sử dụng các mô hình đa phương thức thông qua endpoint [`/chat/completions`](./image-generation-chat).
  :::
  ...
  :::
    ...
    <ApiParameter name="aspect_ratio" type="string" isEnd>
  ...
  <RightColumn>
    <InteractiveApiRequest
      ...
      parameterControls={{
        ...
        n: { type: 'input' },
        aspect_ratio: { type: 'select', options: ['1:1', '3:4', '4:3', '16:9', '9:16'] },
      }}
      codeTemplates={{
        'curl': {
          language: 'bash',
