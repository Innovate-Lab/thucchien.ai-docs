...
Ngoài endpoint này, bạn cũng có thể sử dụng mô hình text-to-speech thông qua endpoint [Google Gemini](./text-to-speech-gemini) với multi-speaker prompts.
:::
<ApiReferenceLayout>
  <LeftColumn>
  ...
  <RightColumn>
    <InteractiveApiRequest
      ...
      parameterControls={{
        ...
        input: { type: 'textarea' },
        voice: { type: 'select', options: ['Zephyr', 'Puck', 'Charon', 'Kore', 'Fenrir', 'Leda', 'Orus', 'Aoede', 'Callirrhoe', 'Autonoe', 'Enceladus', 'Iapetus', 'Umbriel', 'Algieba', 'Despina', 'Erinome', 'Algenib', 'Rasalgethi', 'Laomedeia', 'Achernar', 'Alnilam', 'Schedar', 'Gacrux', 'Pulcherrima', 'Achird', 'Zubenelgenubi', 'Vindemiatrix', 'Sadachbia', 'Sadaltager', 'Sulafat'] },
      }}
      codeTemplates={{
        'curl': {
          language: 'bash',
