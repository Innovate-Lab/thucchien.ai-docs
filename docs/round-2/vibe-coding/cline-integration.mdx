...
---
# Tích hợp với CLine
import ClineIntegrationVideo from '@site/static/video/cline_integration_guide.mkv';
...
![CLine Integration](@site/static/img/cline_integration.png)
...
## Video hướng dẫn
<video width="100%" height="516" controls>
